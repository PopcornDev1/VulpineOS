...
func defaultCommands() []Command {
	return []Command{
		...
		{Name: "pause", Description: "Pause selected agent", Section: "Agent"},
		{Name: "resume", Description: "Resume selected agent", Section: "Agent"},
		{Name: "copy", Description: "Copy latest response", Section: "Agent"},
		{Name: "pauseall", Description: "Pause all agents", Section: "Fleet"},
		{Name: "resumeall", Description: "Resume all paused agents", Section: "Fleet"},
		{Name: "killall", Description: "Kill all live agents", Section: "Fleet"},
		{Name: "view", Description: "Toggle browser visibility", Section: "View"},
		{Name: "hide", Description: "Hide all browser contexts", Section: "View"},
		{Name: "log", Description: "Open selected session log", Section: "View"},
		{Name: "trace", Description: "Toggle trace mode", Section: "View"},
		{Name: "resize", Description: "Toggle resize mode", Section: "View"},
		{Name: "settings", Description: "Open settings panel", Section: "System"},
		{Name: "config", Description: "Open configuration wizard", Section: "System"},
		{Name: "model", Description: "Open model picker", Section: "System"},
