...
The browser-layer test suites below are required when you change Firefox/Vulpine browser patches, browser fingerprinting code, or Python package integration. They test different layers of the browser stack and catch different classes of bugs.
...
python scripts/run_tests.py /path/to/vulpine-binary
```
